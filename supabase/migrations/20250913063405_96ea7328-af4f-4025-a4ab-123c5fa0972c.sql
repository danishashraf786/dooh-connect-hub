...
-- Advertisers can manage their creatives (handle existing policy)
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Advertisers can manage their creatives'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'creatives' 
    AND policyname = 'Screen owners can view creatives for their screens'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Public read creatives'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage' 
    AND tablename = 'objects' 
    AND policyname = 'Users can upload to their creatives folder'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage' 
    AND tablename = 'objects' 
    AND policyname = 'Users can update their own creatives'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage' 
    AND tablename = 'objects' 
    AND policyname = 'Users can delete their own creatives'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Screen owners can update bookings for their screens'
  ) THEN
